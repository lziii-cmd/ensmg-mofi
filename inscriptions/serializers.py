...
class CertificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "tarif_etudiant", "tarif_professionnel", "actif",
            "nb_inscrits", "nb_certifies", "nb_en_formation",
            "montant_encaisse", "created_at",
        ]
...
class CohorteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Cohorte
        fields = [
            "id", "certification", "certification_nom",
            "nom", "date_debut", "date_fin", "actif",
            "nb_inscrits", "nb_certifies", "created_at",
        ]
        read_only_fields = ["created_at"]
...
class InscritSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "adresse", "universite", "entreprise",
            "source", "notes", "date_inscription",
        ]
...
class InscriptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Inscription
        fields = [
            "id", "inscrit", "inscrit_nom",
            "cohorte", "cohorte_nom", "certification_nom",
            "statut", "montant_du",
            "total_paye", "reste_a_payer", "pourcentage_paye",
            "notes", "date_inscription",
        ]
...
class PaiementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Paiement
        fields = [
            "id", "inscription", "inscrit_nom", "certification_nom",
            "montant", "date_paiement", "moyen_paiement",
            "reference", "statut", "notes", "created_at",
        ]
...
class AttestationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Attestation
        fields = [
            "id", "numero", "inscrit_nom", "certification_nom",
            "date_delivrance", "generated_at",
        ]
